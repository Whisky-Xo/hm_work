...
//		StringTemplate st4 =  stGroup.getInstanceOf("com/crm/bean/test");
...
//		
//		//写入excel文件头部信息
//		StringTemplate head =  stGroup.getInstanceOf("com/crm/bean/head");
//		File file = new File("D:/Test.xls");
//		PrintWriter writer = new PrintWriter(new BufferedOutputStream(new FileOutputStream(file)));
...
//			StringTemplate body =  stGroup.getInstanceOf("com/crm/bean/body");
//			Worksheet worksheet = new Worksheet();
