...
public class AuthHelper {
	...
	// " getconfig,url:" + urlString + " query:" + queryString + " corpid:" +
	// corpId + " appid:" + appId);
	//
	...
	public static String getAccessToken2(String coprId, String corpSecret) throws OApiException {
		String url = "https://oapi.dingtalk.com/gettoken?corpid=" + coprId + "&corpsecret=" + corpSecret;
