...
public class MobileLocationUtil {
	...
	/** -- 获取省市信息逗号分隔 -- **/
	public static String getCityStr(String phone) {
		...
		String rst = getMobileNoTrack(phone);
		if (StringUtil.isEmpty(rst) || !rst.startsWith(phone + "：")) {
			return "";
		}
		rst = rst.replace(phone + "：", "");

		String[] adsArr = rst.split(" ");

		rst = adsArr[0] + "," + adsArr[1] + ",,";

		return rst;
	}

	public static void main(String[] args) {
		System.out.println(getCityStr("18700000000"));
	}
}