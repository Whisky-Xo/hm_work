 ...
 *
 */
public class BeidouClientInfoFilter {
	...
	private static Object executeEmptyFill(String template) {
		template = template.replace(
				"<input class=\"check_box info_id${kzid}\" attr-title=\"${kzid}\" onclick=\"checkId('all','${kzid}')\" value=\"1\" name=\"box_all\" type=\"checkbox\">",
				" ");
		template = template.replace(
				"<input class=\"check_box info_id${kzid}\" attr-title=\"${kzid}\" onclick=\"checkId('new','${kzid}')\" value=\"1\" name=\"box_new\" type=\"checkbox\">",
				" ");
		template = template.replace(
				"<input class=\"check_box info_id${kzid}\" attr-title=\"${kzid}\" onclick=\"checkId('trace','${kzid}')\" value=\"1\" name=\"box_trace\" type=\"checkbox\">",
				" ");
		template = template.replace(
				"<input class=\"check_box info_id${kzid}\" attr-title=\"${kzid}\" onclick=\"checkId('order','${kzid}')\" value=\"1\" name=\"box_order\" type=\"checkbox\">",
				" ");
		template = template.replace(
				"<input class=\"check_box info_id${kzid}\" attr-title=\"${kzid}\" onclick=\"checkId('come','${kzid}')\" value=\"1\" name=\"box_come\" type=\"checkbox\">",
				" ");
		template = template.replace(
				"<input class=\"check_box info_id${kzid}\" attr-title=\"${kzid}\" onclick=\"checkId('success','${kzid}')\" value=\"1\" name=\"box_success\" type=\"checkbox\">",
				" ");
		template = template.replace(
				"<input class=\"check_box info_id${kzid}\" attr-title=\"${kzid}\" onclick=\"checkId('invalid','${kzid}')\" value=\"1\" name=\"box_invalid\" type=\"checkbox\">",
				" ");
