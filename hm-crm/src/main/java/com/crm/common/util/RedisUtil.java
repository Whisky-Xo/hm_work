...
public class RedisUtil {
	...
	public RedisUtil() {
		...
		PropertiesUtil pu = new PropertiesUtil("classpath:conf/application.properties");
		...
		if (pool == null) {
			...
			Object ss=System.getProperty("spring.profiles.active");
			if (ss!=null&&ss.equals("pro")) {
				 host=(String) properties.get("redis.pro.host");
				 password = (String) properties.get("redis.pro.password");
				 System.out.println("连接到正式redis环境");
			}else {
				 host=(String) properties.get("redis.dev.host");
				 password = (String) properties.get("redis.dev.password");
				 System.out.println("连接到测试redis环境");
			}
